...
class Recipes with _$Recipes {
  const factory Recipes({
    ...
    @JsonKey(name: "Images")
    String? images,
    @JsonKey(name: "RecipeCategory")
    String? recipeCategory,
    @JsonKey(name: "Keywords")
    String? keywords,
    @JsonKey(name: "RecipeIngredientQuantities")
    String? recipeIngredientQuantities,
    @JsonKey(name: "RecipeIngredientParts")
    String? recipeIngredientParts,
    @JsonKey(name: "AggregatedRating")
    String? aggregatedRating,
    @JsonKey(name: "ReviewCount")
    String? reviewCount,
    @JsonKey(name: "Calories")
    double? calories,
    @JsonKey(name: "FatContent")
    double? fatContent,
    @JsonKey(name: "SaturatedFatContent")
    double? saturatedFatContent,
    @JsonKey(name: "CholesterolContent")
    double? cholesterolContent,
    @JsonKey(name: "SodiumContent")
    double? sodiumContent,
    @JsonKey(name: "CarbohydrateContent")
    double? carbohydrateContent,
    @JsonKey(name: "FiberContent")
    double? fiberContent,
    @JsonKey(name: "SugarContent")
    double? sugarContent,
    @JsonKey(name: "ProteinContent")
    double? proteinContent,
    @JsonKey(name: "RecipeServings")
    String? recipeServings,
    @JsonKey(name: "RecipeYield")
    String? recipeYield,
    @JsonKey(name: "RecipeInstructions")
